...
namespace BNGNode
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        public Color nodeColor = new Color(0.8f, 0.8f, 0.8f);
        ...
        protected void OnEnable()
        {
            ...
            graphHotfix = null;
            graphHotfix = null;
            //SetSubAssetHideFlags(HideFlags.); //DONT TOUCH!!!!!
            //SetSubAssetHideFlags(HideFlags.None); //DONT TOUCH!!!!!
            UpdatePorts();
            Init();
        }
        ...
        {
            TriggerOnValidate(graph);
        }

        void TriggerOnValidate(UnityEngine.Object target)
        {
        ...
        private void SetSubAssetHideFlags(HideFlags flag)
        {
            ...
            //{
                //Debug.Log(o.GetType());
                /*if (o.GetType() != typeof(BlenderNodeGraph))
                {
                    o.hideFlags = flag;
        ...
        public NodePort AddDynamicInput(Type type, Node.ConnectionType connectionType = Node.ConnectionType.Multiple, Node.TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null, string portType = "float")
        {
            return AddDynamicPort(type, NodePort.IO.Input, connectionType, typeConstraint, fieldName, portType: portType);
        }

        /// <summary> Convenience function. </summary>
        /// <seealso cref="AddInstancePort"/>
        /// <seealso cref="AddInstanceInput"/>
        public NodePort AddDynamicOutput(Type type, Node.ConnectionType connectionType = Node.ConnectionType.Multiple, Node.TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null, string portType = "float")
        {
            return AddDynamicPort(type, NodePort.IO.Output, connectionType, typeConstraint, fieldName, portType: portType);
        }

        /// <summary> Add a dynamic, serialized port to this node. </summary>
        /// <seealso cref="AddDynamicInput"/>
        /// <seealso cref="AddDynamicOutput"/>
        private NodePort AddDynamicPort(Type type, NodePort.IO direction, Node.ConnectionType connectionType = Node.ConnectionType.Multiple, Node.TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null, string portType = "float")
        {
            if (fieldName == null)
            {
            ...
            NodePort port = new NodePort(fieldName, type, direction, connectionType, typeConstraint, this, portType);
        ...
        public virtual void OnCreateConnection(NodePort from, NodePort to) { TriggerOnValidate(graph); }

        /// <summary> Called after a connection is removed from this port </summary>
        /// <param name="port">Output or Input</param>
        public virtual void OnRemoveConnection(NodePort port) { TriggerOnValidate(graph); }
