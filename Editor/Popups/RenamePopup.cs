        ...
        private void OnGUI() {
            ...
            if (input == null || input.Trim() == "") {
                if (GUILayout.Button("Revert to default") || (e.isKey && e.keyCode == KeyCode.Return)) {
                    ...
                    NodeEditor.GetEditor((BNGNode.Node)target, NodeEditorWindow.current).OnRename();
                    AssetDatabase.SetMainObject((target as BNGNode.Node).graph, AssetDatabase.GetAssetPath(target));
