...
namespace BNGNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static Type[] GetNodeTypes() {
            ...
            return GetDerivedTypes(typeof(BNGNode.Node));
        }
        ...
        public static bool TryGetAttributeTint(this Type nodeType, out Color tint) {
            if (nodeTint == null) {
                CacheAttributes<Color, BNGNode.Node.NodeTintAttribute>(ref nodeTint, x => x.color);
            }
        ...
        public static bool TryGetAttributeWidth(this Type nodeType, out int width) {
            if (nodeWidth == null) {
                CacheAttributes<int, BNGNode.Node.NodeWidthAttribute>(ref nodeWidth, x => x.width);
            }
        ...
        public static FieldInfo GetFieldInfo(this Type type, string fieldName) {
            ...
            while (field == null && (type = type.BaseType) != typeof(BNGNode.Node)) field = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
            return field;
        }
        ...
        public static void OpenPreferences() {
            try {
                ...
                SettingsService.OpenUserPreferences("Preferences/Blender Nodes Editor");
#else
