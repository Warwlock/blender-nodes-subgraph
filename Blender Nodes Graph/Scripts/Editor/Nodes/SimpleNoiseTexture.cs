...
{
    [NodeTint("#9F5E38")]
    [CreateNodeMenu("Texture/Simple Noise Texture")]
    [HelpURL("https://github.com/Warwlock/blender-nodes-subgraph/wiki/Using-Textures")]
    public class SimpleNoiseTexture : Node
    {
        [ContextMenu("Help")]
        public void GetHelp()
        {
        ...
        public enum dimensionType {_2D, _3D, _4D }
        ...
        public override object GetValue(NodePort port)
        {
            ...
            if (port.fieldName == "Result")
            {
                return sFac_first + sW_first + sDetail_first + sRough_first + sDistort_first + sVector_first +
                    ...
                    string.Format("node_simple_noise_texture_full({0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}, {8})",
    ...
    [CustomNodeEditor(typeof(SimpleNoiseTexture))]
    public class SimpleNoiseTextureEditor : NodeEditor
    {
        SimpleNoiseTexture serializedNode;
        public override void OnBodyGUI()
        {
            if (serializedNode == null) serializedNode = target as SimpleNoiseTexture;
            ...
            if (serializedNode.dimenType == SimpleNoiseTexture.dimensionType._4D)
