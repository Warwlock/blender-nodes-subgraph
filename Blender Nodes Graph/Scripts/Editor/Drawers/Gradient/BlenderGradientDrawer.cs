...
public class BlenderGradientDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        for (int i = 0; i < gradient.NumKeys; i++)
        {
            ...
            GUI.DrawTexture(keyRectf, pin, ScaleMode.StretchToFill, true, 0, key.Color.gamma, 0, 0);
            keyRects[i] = keyRectf;
        }
        ...
        GUI.DrawTexture(keyRect, pin, ScaleMode.StretchToFill, true, 0, gradient.GetKey(selectedKeyIndex).Color.gamma, 0, 0);
