        ...
        if (path != null && path != "")
        {
            ...
            for (int i = 0; i < format.nodeDatas.Length; i++)
            {
                ...
                for (int t = 0; t < format.nodeDatas[i].connections0Name.Length; t++)
                {
                    ...
                    Debug.Log(format.nodeDatas[i].connections0Name[t]);
                    Debug.Log(format.nodeDatas[i].connections0NodeName[t]);
                    Debug.Log(jsonNodes[i].GetType());
                    if (port == null)
                        continue;
                ...
                for (int t = 0; t < format.nodeDatas[i].connections1Name.Length; t++)
                {
                    ...
                    Debug.Log(format.nodeDatas[i].connections1Name[t]);
                    Debug.Log(format.nodeDatas[i].connections1NodeName[t]);
                    Debug.Log(jsonNodes[i].GetType());
                    if (port == null)
                        continue;
                    if (jsonNodes[i].GetType() == typeof(BrickTexture) ||
                ...
                for (int t = 0; t < format.nodeDatas[i].connections2Name.Length; t++)
                {
                    ...
                    Debug.Log(format.nodeDatas[i].connections2Name[t]);
                    Debug.Log(format.nodeDatas[i].connections2NodeName[t]);
                    Debug.Log(jsonNodes[i].GetType());
                    if (port == null)
                        continue;
                ...
                for (int t = 0; t < format.nodeDatas[i].connections3Name.Length; t++)
                {
                    ...
                    Debug.Log(format.nodeDatas[i].connections3Name[t]);
                    Debug.Log(format.nodeDatas[i].connections3NodeName[t]);
                    Debug.Log(jsonNodes[i].GetType());
                    if (port == null)
                        continue;
                    if (jsonNodes[i].GetType() == typeof(VoronoiTexture))
                ...
                for (int t = 0; t < format.nodeDatas[i].connections4Name.Length; t++)
                {
                    ...
                    Debug.Log(format.nodeDatas[i].connections4Name[t]);
                    Debug.Log(format.nodeDatas[i].connections4NodeName[t]);
                    Debug.Log(jsonNodes[i].GetType());
                    if (port == null)
                        continue;
                    if (jsonNodes[i].GetType() == typeof(VoronoiTexture))
            ...
            (NodeEditorWindow.current.graph as BlenderNodeGraph).SetSubAssetHideFlags(HideFlags.HideInHierarchy);
